...
const REQUEST_TYPES = [
    {
        ...
        name: "شهادة قيد",
        icon: FileText,
        description: "طلب شهادة قيد للطالب",
    },
    {
        id: "transcript",
        name: "كشف درجات",
    ...
    },
    {
        ...
        name: "انسحاب من مادة",
        icon: XCircle,
        description: "طلب الانسحاب من مادة دراسية",
    },
    {
        id: "study_deferment",
        name: "تأجيل الدراسة",
        icon: Clock,
        description: "طلب تأجيل الفصل الدراسي",
    },
    {
        id: "grade_appeal",
        name: "اعتراض على درجة",
        icon: AlertTriangle,
        description: "تقديم اعتراض على درجة مادة",
    },
];
                ...
                <Card className="bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
                    <CardContent className="p-6">
                        ...
                        <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-300">
                            ...
                            <li>• يمكنك متابعة حالة طلبك من هذه الصفحة</li>
                            <li>
                                • في حالة رفض الطلب، ستجد السبب في ملاحظات
                                الإدارة
                            </li>
                            <li>
                                • يمكنك إعادة تقديم الطلب بعد معالجة سبب الرفض
                            </li>
                        </ul>
                    </CardContent>
                </Card>
